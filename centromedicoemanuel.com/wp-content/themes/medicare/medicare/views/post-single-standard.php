<?php
		...
		if ( $blog_author || $blog_date || $show_comments_number ) {
				...
				if ( $show_comments_number ) {
					$subtitle_html .= '<a href="' . esc_url_raw( $permalink ) . '#comments" class="btArticleComments">' . esc_html( $comments_number ) . '</a>';
				}
			...
			echo '<div class="port">';
				...
				echo '<div class="boldRow">';
					echo '<div class="rowItem btTextLeft col-sm-12 btArticleHeader">';
						...
						echo boldthemes_get_heading_html( $supertitle_html, get_the_title(), $subtitle_html , 'large', $dash, 'btAlternateDash', '' ) ;
